  ...
  <script type="text/javascript">
    ...
    <br>
      ...
      <section class="login-content">
         ...
         <div class="login-box" style="height: 1400px;">
         
            <img src="img1/logo1.png" style="height: 150px; margin-left:150px;">
          <br>
      
            
          <form class="login-form" method ="post" action="lib/controller_manager.php" enctype="multipart/form-data">
            <br>
            <br>
            <br>
            <h6 class="login-head"><i class="fa fa-lg fa-fw fa-user"></i><center>REGISTER</center></h6>
           <div class="form-group">
                  ...
                  <div class="form-group">
                     ...
                     <div class="form-check">
                        ...
                        <input class="form-check-input" type="radio" name="gender" value="male" required style="margin-left:40px;">Male
                        </label>
                        <label class="form-check-label" style="margin-left:25px;">
                        <input class="form-check-input" type="radio" name="gender" value="female" required style="margin-left:50px;">Female
                        </label>
                     </div>
                  </div>
                  <div class="form-group" >
